...
export default function CalendarStrip() {
    ...
    function handleScroll(event: NativeSyntheticEvent<NativeScrollEvent>) {
        ...
        const selectedDrift = Math.abs(
            scrollX - centerOffsetFor(selectedIndex, viewportWidth)
        )
            ...
            <View style={styles.headerRow}>
                ...
                <View style={styles.pillRow}>
                    {showSelectedPill ? (
                        <Pressable
                            onPress={() =>
                                scrollToIndex(selectedIndex, days[selectedIndex])
                            }
                            style={styles.pill}
                        >
                            <Ionicons
                    ...
                    {showTodayPill ? (
                        <Pressable
                            onPress={() => scrollToIndex(todayIndex, today)}
                            style={styles.pill}
                        >
                            <Ionicons
                                name="locate-outline"
                        ...
                        return (
                            ...
                            >
                                <Text
                                    ...
                                    style={[
                                        styles.dayLabel,
                                        active && styles.dayLabelSelected
                                    ]}
                                >
                                    {item.weekday}
                                </Text>
