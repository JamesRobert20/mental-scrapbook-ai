...
type ExpoTabBarOptions = { href?: string | null }

function isVisibleTabRoute(
    routeName: string,
    options: ExpoTabBarOptions | undefined
): boolean {
    if (!TAB_CONFIG[routeName]) return false
...
export default function PillTabBar({
    ...
    const visibleRoutes = state.routes.filter(route =>
        isVisibleTabRoute(
            route.name,
            descriptors[route.key]?.options as ExpoTabBarOptions | undefined
        )
    )
